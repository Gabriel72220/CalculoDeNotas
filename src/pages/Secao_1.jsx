...
const Secao_1 = () => {
  ...
  const [mensagem, setMensagem] = useState('Digite suas 3 notas para saber sua Média e seu status');
  ...
  const handleCalculate = () => {
    ...
    if (media >= 7) {
      ...
      if (fazerSubstitutiva) {
        ...
        setMensagem('Deve fazer avaliação substitutiva');
      } else {
        setMaioresNotas({media:media, substituta:false})
        setMensagem('Deve fazer exame final');
      }
    }
  ...
  return (
    <div id="formulario">
      <h2 className='titulo'>Calculo da média</h2>
        ...
        <div id="conteudo">
          <div id="esquerda">
            <div className="media-input">
              ...
              <input value={nota1} name="nota1" id="nota1" className="check" type="text" onChange={(e) => setNota1(e.target.value)} />
            </div>
            <div className="media-input">
              <p id="p_style">
                2° nota:
            ...
            <div className="media-input">
              ...
              <input value={nota3} name="nota3" id="nota3" className="check" type="text" onChange={(e) => setNota3(e.target.value)} />
            </div>
            <div className="media-input">
              <input
                type="checkbox"
